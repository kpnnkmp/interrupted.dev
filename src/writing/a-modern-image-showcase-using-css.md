...
layout: post
description: >-
  Grid template areas combined with other modern CSS make for powerful adaptable layouts. I use them here to build a picture showcase for many configurations.
---
